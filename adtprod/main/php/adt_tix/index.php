<!--Panel for ITSM-->
            <div role="tabpanel" class="tab-pane fade show container active" id="div_itsm" aria-labelledby="div_itsm-tab">
                ...
                <form id = 'itsm_form'>
                    ...
                    <div class = 'form-row'>
                        <div class = 'col-md-6'>
                            ...
                            <select class = 'form-control' id = 'adt_app_list' name = 'adt_app_list'> <!--itsm_app_list-->
                            </select>
                        </div>
                        <div class = 'col-md-6'>
                            <label for = 'adt_task_list'><span class="required-mark">*</span>Ticket Task:</label>
                            <select class = 'form-control' id = 'adt_task_list' name = 'adt_task_list' > <!--itsm_task_list-->
                            </select>
                        </div>
                    </div>
                    <br>
                ...
                <br>
                <table class="table table-striped table-bordered" id = 'table_adt' width="100%">
                        <thead>
                            <tr>
